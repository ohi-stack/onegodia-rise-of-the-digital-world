            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium font-mono transition-all ${
                    isActive
                      ? 'bg-blue-600/20 text-blue-300 border border-blue-500/50 shadow-sm shadow-blue-500/20 font-semibold'
                      : 'text-slate-400 hover:text-slate-200 hover:bg-[#161821] border border-transparent'
                  }`}
                >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-2 px-2.5 py-1 bg-[#11131a] border border-[#1e2230] rounded font-mono text-xs">
              <div className="flex items-center gap-1 text-amber-400">
                ...
                <span className="font-semibold">{progress.credits}</span>
                <span className="text-[9px] text-slate-500">CR</span>
              </div>
              <div className="w-px h-3 bg-slate-800"></div>
              <div className="flex items-center gap-1 text-slate-400 text-[10px]" title="ODC Economy is Roadmap only (Simulated Inactive)">
                <span className="text-blue-400 font-medium">0.00</span>
                <span>ODC</span>
                <span className="text-[8px] px-1 bg-[#161821] text-slate-500 rounded border border-slate-800">Lock</span>
              </div>
            </div>
            ...
            <button
              ...
              className="xl:hidden p-1.5 rounded bg-[#11131a] border border-[#1e2230] text-slate-400 hover:text-white"
        ...
        <div className="xl:hidden bg-[#0c0e14]/98 border-b border-[#1e2230] px-4 pt-2 pb-4 space-y-1 backdrop-blur-xl">
          <div className="py-1.5 px-2.5 mb-2 bg-[#11131a] rounded border border-[#1e2230] flex items-center justify-between font-mono text-xs">
            ...
            <div className="flex items-center gap-3 text-[11px]">
              ...
              <span className="text-slate-500">0.00 ODC (Locked)</span>
            </div>
          </div>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-2.5 py-1.5 rounded text-xs font-medium text-left transition-colors ${
                    isActive
                      ...
                      : 'text-slate-400 hover:bg-[#161821] hover:text-slate-200 border border-[#161821]'
                  }`}
                >
                  <Icon className={`w-3.5 h-3.5 ${isActive ? 'text-blue-400' : 'text-slate-500'}`} />
